...
class BebidaDAO
{
    ...
    {
        $json = file_get_contents(__DIR__ . '/../view/bebidas.json');
        return json_decode($json, true, 512, JSON_UNESCAPED_UNICODE);
    }

    public function salvarBebidas($bebidas)
    {
        $json = json_encode($bebidas, JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT);
        file_put_contents(__DIR__ . '/../view/bebidas.json', $json);
    }
