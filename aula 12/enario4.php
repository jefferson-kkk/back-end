...
// Verbos: comprarIngresso(), escolherFilme(), exibirSessao(), assistirFilme()
...
class Filme {
    public $titulo;
    public $genero;
    function __construct($titulo, $genero) { $this->titulo = $titulo; $this->genero = $genero; }
}

class Sessao {
    public $filme;
    public $horario;
    function __construct($filme, $horario) { $this->filme = $filme; $this->horario = $horario; }
    function exibirSessao() { echo "Sessão de {$this->filme->titulo} às {$this->horario}.<br>"; }
}
...
class Cinema {
    ...
    public $sessoes = [];
    function __construct($nome) { $this->nome = $nome; }
    function adicionarSessao($sessao) { $this->sessoes[] = $sessao; echo "Sessão de {$sessao->filme->titulo} adicionada ao cinema {$this->nome}.<br>"; }
}
