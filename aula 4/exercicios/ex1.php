<?php
$escolha = (int) readline("esolha um carro de 1 a 4: ");
...
if ($revisao == true){
   echo "o carro: $modelo, da marca: $marca, do ano: $ano, não passou por revisao e teve $donos donos";
}else{
   echo "o carro: $modelo, da marca: $marca, do ano: $ano, passou por revisao e teve $donos donos";
}
} 
?>